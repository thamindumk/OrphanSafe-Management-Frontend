...
const DashboardOverview = () => {
    return (
      ...
      <h1 className="name-headers">Overview</h1>
        <Row className="profile" style={{paddingTop: "30px",paddingLeft:"50px"}}>
        <Col md={3} sm={6} xs={12}style={{marginBottom: "10px"}}>
        <Card className="shadow">
            <Row className="CardRow">
            <Col className="colDec text-end">
                <i className="fas fa-user-circle" style={{ fontSize: '30px', marginRight: '10px' }}></i>
                Child profiles
            </Col>
            </Row>
      ...
      <Col md={3} sm={6} xs={12} style={{marginBottom: "10px"}}>
        <Card className="shadow">
            <Row className="CardRow">
            <Col className="colDec text-end">
                <i className='fas fa-globe' style={{ fontSize: '30px', marginRight: '10px' }}></i>
                Working Staff
            </Col>
            </Row>
      ...
      <Col md={3} sm={6} xs={12} style={{marginBottom: "10px"}}>
        <Card className="shadow">
            <Row className="CardRow">
            <Col className="colDec text-end">
                <i className="fa fa-heart" style={{ fontSize: '30px', marginRight: '10px' }}></i>
                Ongoing Adoptions
            </Col>
            </Row>
      ...
      <Col md={3} sm={6} xs={12} style={{marginBottom: "10px"}}>
        <Card className="shadow">
            <Row className="CardRow">
            <Col className="colDec text-end">
                <i className="fas fa-university" style={{ fontSize: '30px', marginRight: '10px' }}></i>
                Case Management
            </Col>
            </Row>
